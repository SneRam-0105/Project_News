...
const About_us = () => {
  const { isDarkMode } = useOutletContext();  // Accessing isDarkMode context

  return (
    <Box
      sx={{
        minHeight: "100vh",
        backgroundColor: isDarkMode ? "#191919" : "#e6e6e6", // Conditionally set background color
        color: isDarkMode ? "#e6e6e6" : "#000", // Conditionally set text color
        display: "flex",
    ...
    >
      ...
      <Grid container spacing={3} justifyContent="center">
        <Grid item xs={12} sm={6} md={3}>
          <Card
            sx={{
              backgroundColor: isDarkMode ? "#2a2a2a" : "#f1f1f1", // Card background color
              color: isDarkMode ? "#e6e6e6" : "#000", // Text color
              textAlign: "center",
            }}
          >
            <CardContent>
